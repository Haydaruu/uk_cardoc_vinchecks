...
export default function AuthLayoutLeftPanel() {
    return (
        <div className="relative hidden h-full min-h-svh flex-col justify-between bg-primary p-12 text-white lg:flex">
            ...
            <img
                src="/images/backgrounds/bg_login_register.webp"
            ...
            <div className="absolute bottom-0 right-0 w-full h-full bg-gradient-to-tr from-primary/40 to-transparent pointer-events-none" />
