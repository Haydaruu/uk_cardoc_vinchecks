    ...
    return (
        <>
            ...
            <div className="mb-5 grid grid-cols-2 gap-3">
                ...
                <a href="http://localhost:8000/auth/microsoft/redirect" className="flex h-11 items-center justify-center gap-2 rounded border border-[#c5c6d1] bg-white px-4 text-sm font-semibold text-[#151c27] transition-all hover:bg-[#f0f3ff] hover:border-[#00205b]">
                    {/* SVG Microsoft */}
                    <svg className="h-4 w-4" viewBox="0 0 23 23" fill="currentColor">
                        <rect x="1" y="1" width="10" height="10" />
                        <rect x="12" y="1" width="10" height="10" opacity="0.7" />
                        <rect x="1" y="12" width="10" height="10" opacity="0.85" />
                        <rect x="12" y="12" width="10" height="10" opacity="0.55" />
                    </svg>
                    MICROSOFT
                </a>
            </div>
