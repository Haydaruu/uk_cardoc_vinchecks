        ...
        <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/95 backdrop-blur-sm">
            <div className="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-6 md:px-10">
                ...
                <div className="hidden items-center gap-5 md:flex">
                    ...
                    <>
                        <span className="flex items-center gap-1.5 rounded-sm bg-secondary px-4 py-2 text-[11px] font-bold uppercase tracking-widest text-white">
                            ★ Premium
                        </span>
                        <ProfileDropdown name={auth.user.name} />
                    </>
                ) : (
                    <>
