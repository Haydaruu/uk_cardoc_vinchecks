...
function Pricing() {
    ...
    const selectMembershipPlan = (
         ...
         * subscription aktif.
         *
         * Kalau klik plan lain,
         * gunakan Change Plan flow
         * yang sudah ada.
         */
        if (hasSubscription) {
            if (
        ...
        /*
         * User belum subscription.
         *
         * Masuk ke unified checkout
         * Card / PayPal.
         */
        router.visit(
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`relative flex flex-col rounded-sm border bg-white p-8 transition-shadow hover:shadow-md ${
                                                ...
                                                isCurrentPlan
                                                    ? 'ring-2 ring-primary-container/20'
                                                    : ''
                                            }`}
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="mt-3">
                                                    ...
                                                    {isCurrentPlan && (
                                                        <span className="ml-2 inline-flex rounded-sm bg-secondary/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-secondary">
                                                            Current
                                                            Plan
                                                        </span>
                                                    )}
                                            ...
                                            <button
                                                ...
                                                className={`mt-8 rounded-sm py-3.5 text-center text-[11px] font-bold uppercase tracking-widest transition-colors disabled:cursor-not-allowed disabled:opacity-60 ${
                                                    isCurrentPlan
                                                        ? 'border border-primary-container/20 bg-surface-container text-primary-container'
                                                        : plan.highlighted
